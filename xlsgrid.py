...
class XLSCell(object):
    ...
    def __init__(self, book, cell, xf_index, xls_text, xls_comment, hyperlink, rich_text, default_width,
                 default_colour):
        """
        Default class constructor.
    ...
    def SetupCell(self, book, cell, xf_index, xls_text, xls_comment, hyperlink, rich_text, default_width,
                  default_colour):
        """
...
class XLSGrid(gridlib.Grid):
    ...
    def PopulateGrid(self, book, sheet, display_texts, comments):
        ...
        for i in xrange(nrows):
            ...
            for j in xrange(ncols):
                ...
                self.FormatCell(book, sheet, i, j, display_texts, comments, hyperlink, rich_text, default_width,
                                default_colour)
    ...
    def FormatCell(self, book, sheet, row, col, display_texts, comments, hyperlink, rich_text, default_width,
                   default_colour):
        """
        ...
        gridCell = XLSCell(book, cell, xf_index, xls_text, xls_comment, hyperlink, rich_text, default_width,
                           default_colour)
